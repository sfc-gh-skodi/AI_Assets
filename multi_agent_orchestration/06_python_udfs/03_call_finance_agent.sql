...
-- =============================================================
-- Calls the FINANCE_AGENT via the Cortex Agents REST API using
-- Server-Sent Events (SSE) streaming.
--
-- Same pattern as 01_call_sales_agent.sql — see that file for
-- the full explanation of SSE parsing and PAT token flow.
--
-- The Finance Agent answers questions about:
-- - Department budgets vs actuals by category and month
-- - Expense transactions by vendor, category, and department
-- =============================================================
...
def run_agent(user_query):
    """
    Calls the FINANCE_AGENT via REST API and returns the text response.
    ...
    url = "https://sfpscogs-thb83496.snowflakecomputing.com/api/v2/databases/DEMOS/schemas/WEWORK/agents/FINANCE_AGENT:run"
